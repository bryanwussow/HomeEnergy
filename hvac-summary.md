...
**Preliminary loop design (2026-08-28):** `geothermal loop design - preliminary.md` runs the design prompt against the above figures plus `Wussow Ground Loop Plot Plan.pdf`. Recommended design: **~1,800 ft total pipe (900 ft per loop, 2 loops)**, 1" SDR-11 HDPE, ~9 GPM system flow, ~20% propylene glycol. Cooling load governs sizing (not heating). Several inputs remain unconfirmed pending soil testing and contractor/PE review — see that document's "Assumptions and Flags."
