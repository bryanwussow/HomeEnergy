...
- **Near the house:** both loops converge; outgoing lines run at 24 in. depth, return lines in a separate sleeve 12 in. below (≈36 in. depth), optionally separated by 2 in. rigid foam, before reaching whichever manifold location is chosen below.
