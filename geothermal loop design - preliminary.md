...
- **Fluid:** ~20% propylene glycol — gives freeze protection below the coldest point in the system, the estimated ~20–22°F LWT entering the ground loop (colder than the 30°F design EWT — see Step 3), without the flammability/handling concerns of methanol. Confirm against manufacturer-approved fluid list.
